...
export default function CompanyProfile({recruiterData,setActiveContent, previousComponent, isRecruiter=false}) {
  ...
  return (
    <div className="profile companyProfile text-white">
      ...
      <hr />
      {
        isRecruiter ? "" : (<button className="backBtn fs-5 py-1 ps-2 pe-3 mb-3 rounded-3 d-flex align-items-center fw-bold" onClick={()=> {console.log(previousComponent), setActiveContent(previousComponent)}} ><FaArrowLeft className="me-2" />BACK</button>)
      }
      <div className="d-flex justify-content-between flex-wrap">
        <div className="info flex-grow-1 me-3">
          <div className="d-flex header gap-4 mb-4 align-items-center p-3 rounded border border-white position-relative">
            {
              isRecruiter ? (<button className="position-absolute editBtn" onClick={()=> setActiveContent("editCompanyInfo")} >Edit</button>) : ("")
            }
            <div
              ...
              <div className="d-flex flex-wrap gap-4 mt-3">
                <div className="d-flex align-items-center gap-2">
                  ...
                  <div>
                    ...
                    <small className="opacity-75">{dateFormat(recruiterData?.company?.founded)}</small>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center gap-2">
                  ...
                  <div>
                    ...
                    <small className="opacity-75">{recruiterData?.company?.employees}</small>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center gap-2">
                  ...
                  <div>
                    ...
                    <small className="opacity-75">{recruiterData?.company?.location}</small>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center gap-2">
                  ...
                  <div>
                    ...
                    <small className="opacity-75">{recruiterData?.company?.industry}</small>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div className="d-flex gap-5 flex-wrap mt-4 ms-3">
    ...
    <div className="text-center">
      ...
      <small className="opacity-75">Developer</small>
        ...
        <div className="additionalInfo flex-shrink-0 mt-3 mt-lg-0">
          <div className="p-4 rounded border border-white overflow-hidden">
            ...
            <div className="d-flex align-items-center mt-2 mb-3">
              ...
              <div>
                ...
                <div className="text-white opacity-75">{recruiterData?.company?.contact?.emailId}</div>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center mt-2 mb-3">
              ...
              <div>
                ...
                <div className="text-white opacity-75">{recruiterData?.company?.contact?.twitter}</div>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center mt-2 mb-3">
              ...
              <div>
                ...
                <div className="text-white opacity-75">{recruiterData?.company?.contact?.facebook}</div>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center mt-2 mb-3">
              ...
              <div>
                ...
                <div className="text-white opacity-75">{recruiterData?.company?.contact?.linkedin}</div>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center mt-2">
              ...
              <div>
                ...
                <div className="text-white opacity-75">{recruiterData?.company?.contact?.website}</div>
              </div>
            </div>
          </div>
        </div>
