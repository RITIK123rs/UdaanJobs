...
export default function JobDetail({
  ...
  return (
    <div className="jobDetail">
      ...
      <hr className="my-3" />
      <button
        className="backBtn fs-5 p-1 px-2 mb-3 rounded-3 d-flex align-items-center fw-bold"
        onClick={() =>
          isAdmin
        ...
        {!isRecruiter ? (
          <button
            ...
            onClick={() =>
              applyJob({
                id: selectData._id,
                applicants: selectData.applications,
              })
            }
          >
            Apply Now
      ...
      <div className="jobBody mt-4 px-3 py-3">
        <div className="mt-2">
          ...
          <p className="mt-3 fs-5">{selectData?.jobDescription}</p>
        </div>
        ...
        <div className="mt-5">
          ...
          <p className="fs-5">{selectData?.roleAndResponsibilities}</p>
        </div>
        ...
        <div className="mt-4 fs-5 jobInfo">
          ...
          <p>
            ...
            {selectData?.experience}{" "}
            {selectData?.experience != "fresher" ? "Years" : ""}
          </p>
          <p>
          ...
          <p>
            ...
            {dateFormat(selectData?.applyBefore)}
          </p>
          <p>
